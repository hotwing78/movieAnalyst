...
var NON_INTERACTIVE_CLIENT_ID = 'pZuU104gF6GJOCxG9Q5dHAEhvWv2GjPS';
var NON_INTERACTIVE_CLIENT_SECRET = 'Eur3KeKH9jvnBTIFrmKIQWAZKXgo5jq1ODIrsF4bvXvkjQUC7k4dXreRE_9cKtNs';
...
var authData = {
  ...
  audience: 'https://movieanalystadmin.com'
}
...
function getAccessToken(req, res, next){
  request
    .post('https://hotwing78.auth0.com/oauth/token')
    .send(authData)
